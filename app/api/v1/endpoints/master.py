...
# PELANGGAN ENDPOINTS
# ==========================================
@router.get("/pelanggan", response_model=list[PelangganResponse])
def get_pelanggan_list(
    ...
    return master_service.get_master_list(db, Pelanggan, skip, limit, ["nama", "kode"], search)
...
def get_supplier_list(
    ...
    return master_service.get_master_list(db, Supplier, skip, limit, ["nama", "kode"], search)
...
# BARANG ENDPOINTS
# ==========================================
@router.get("/barang", response_model=list[BarangResponse])
def get_barang_list(
    skip: int = Query(0, ge=0),
    limit: int = Query(100, ge=1),
    search: Optional[str] = Query(None),
    ...
    return master_service.get_master_list(db, Barang, skip, limit, ["nama", "kode"], search)
