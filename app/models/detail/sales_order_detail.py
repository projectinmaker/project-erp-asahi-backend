...
class SalesOrderDetail(BaseModel, BaseMixin):
    ...
    # === NEW Phase B — Catatan Sales Order §5: UOM on detail ===
    satuan_id = Column(UUID(as_uuid=True), ForeignKey("satuan.id", name="fk_so_detail_satuan"), nullable=True, index=True)
